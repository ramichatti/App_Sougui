...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'nav.rolesAccess': { fr: 'Rôles & Accès', en: 'Roles & Access' },
    'nav.emailSettings': { fr: 'Configuration Email', en: 'Email Settings' },
    'nav.mlModels': { fr: 'Modèles ML', en: 'ML Models' },
    'nav.myDashboards': { fr: 'Mes Dashboards', en: 'My Dashboards' },
    'nav.adminSection': { fr: 'Administration', en: 'Administration' },
    'nav.maintenance': { fr: 'En maintenance · Update soon', en: 'Under maintenance · Update soon' },
    'nav.lang.fr': { fr: 'Français', en: 'French' },
    'nav.lang.en': { fr: 'Anglais', en: 'English' },
    'nav.lang.short.fr': { fr: 'FR', en: 'FR' },
    'nav.lang.short.en': { fr: 'EN', en: 'EN' },
    'nav.lang.switch': { fr: 'Changer de langue', en: 'Switch language' },
    ...
    'dashboard.usersWithAccess': { fr: 'Utilisateurs avec accès', en: 'Users with access' },
    'dashboard.user': { fr: 'utilisateur', en: 'user' },
    'dashboard.users': { fr: 'utilisateurs', en: 'users' },
    'dashboard.loadingUsers': { fr: 'Chargement...', en: 'Loading...' },
    'dashboard.adminBadge': { fr: 'Admin', en: 'Admin' },
    ...
    // ML Models
    'ml.title': { fr: 'Prédiction de la Demande', en: 'Demand Prediction' },
    'ml.subtitle': { fr: 'Anticipez les besoins futurs avec l\'intelligence artificielle', en: 'Anticipate future needs with artificial intelligence' },
    'ml.models': { fr: 'Modèles', en: 'Models' },
    'ml.mlModels': { fr: 'Modèles ML', en: 'ML Models' },
    'ml.demandPrediction': { fr: 'Prédiction de la Demande', en: 'Demand Prediction' },
    'ml.demandPredictionDesc': { fr: 'Anticipez les besoins futurs avec l\'IA', en: 'Anticipate future needs with AI' },
    'ml.advancedAnalysis': { fr: 'Analyse Prédictive Avancée', en: 'Advanced Predictive Analysis' },
    'ml.comingSoon': { fr: 'Bientôt disponible', en: 'Coming soon' },
    'ml.maintenance': { fr: 'En maintenance · Update soon', en: 'Under maintenance · Update soon' },
    
    // ML Predictions
    'ml.totalPredicted': { fr: 'Total Prédit (3 mois)', en: 'Total Predicted (3 months)' },
    'ml.averageConfidence': { fr: 'Confiance Moyenne', en: 'Average Confidence' },
    'ml.trend': { fr: 'Tendance', en: 'Trend' },
    'ml.volatility': { fr: 'Volatilité', en: 'Volatility' },
    'ml.prediction': { fr: 'Prédiction', en: 'Prediction' },
    
    // ML Search & Filters
    'ml.searchProduct': { fr: 'Rechercher un produit…', en: 'Search for a product…' },
    'ml.all': { fr: 'Tous', en: 'All' },
    'ml.predict': { fr: 'Prédire', en: 'Predict' },
    'ml.analyzing': { fr: 'Analyse...', en: 'Analyzing...' },
    'ml.selected': { fr: 'Sélectionné', en: 'Selected' },
    'ml.select': { fr: 'Sélectionner', en: 'Select' },
    
    // ML Products
    'ml.productsFound': { fr: 'produit', en: 'product' },
    'ml.productsFoundPlural': { fr: 'produits trouvés', en: 'products found' },
    'ml.page': { fr: 'Page', en: 'Page' },
    'ml.of': { fr: 'sur', en: 'of' },
    'ml.noProducts': { fr: 'Aucun produit trouvé', en: 'No products found' },
    'ml.noProductsDesc': { fr: 'Essayez de modifier vos critères de recherche', en: 'Try adjusting your search criteria' },
    
    // ML Results
    'ml.predictionResults': { fr: 'Résultats de la Prédiction', en: 'Prediction Results' },
    'ml.clear': { fr: 'Effacer', en: 'Clear' },
    'ml.unitsPredicted': { fr: 'unités prédites', en: 'units predicted' },
    'ml.confidence': { fr: 'Confiance', en: 'Confidence' },
    'ml.min': { fr: 'Min', en: 'Min' },
    'ml.max': { fr: 'Max', en: 'Max' },
    'ml.estimatedRevenue': { fr: 'Revenu estimé', en: 'Estimated Revenue' },
    
    // ML Analysis
    'ml.advancedAnalysisTitle': { fr: 'Analyse Avancée', en: 'Advanced Analysis' },
    'ml.trendLabel': { fr: 'Tendance', en: 'Trend' },
    'ml.trendRising': { fr: 'croissante', en: 'rising' },
    'ml.trendFalling': { fr: 'décroissante', en: 'falling' },
    'ml.trendStable': { fr: 'stable', en: 'stable' },
    'ml.volatilityLabel': { fr: 'Volatilité', en: 'Volatility' },
    'ml.volatilityLow': { fr: 'Faible', en: 'Low' },
    'ml.volatilityModerate': { fr: 'Modérée', en: 'Moderate' },
    'ml.volatilityHigh': { fr: 'Élevée', en: 'High' },
    'ml.dataQuality': { fr: 'Qualité des Données', en: 'Data Quality' },
    'ml.dataQualityExcellent': { fr: 'Excellente', en: 'Excellent' },
    'ml.dataQualityGood': { fr: 'Bonne', en: 'Good' },
    'ml.dataQualityAcceptable': { fr: 'Acceptable', en: 'Acceptable' },
    'ml.seasonality': { fr: 'Saisonnalité', en: 'Seasonality' },
    'ml.seasonalityDetected': { fr: 'Détectée ✓', en: 'Detected ✓' },
    'ml.seasonalityNotDetected': { fr: 'Non détectée', en: 'Not detected' },
    
    // ML Historical Data
    'ml.historicalData': { fr: 'Données Historiques (6 derniers mois)', en: 'Historical Data (Last 6 months)' },
    'ml.unitsSold': { fr: 'unités vendues', en: 'units sold' },
    'ml.orders': { fr: 'cmd', en: 'orders' },
    'ml.customers': { fr: 'clients', en: 'customers' },
    
    // ML Pagination
    'ml.previous': { fr: 'Précédent', en: 'Previous' },
    'ml.next': { fr: 'Suivant', en: 'Next' },
    
    // Distance Analysis
    'distance.title': { fr: 'Analyse de la distance parcourue', en: 'Distance Analysis' },
    'distance.subtitle': { fr: 'Calculez la distance entre l\'entrepôt Sougui et vos clients', en: 'Calculate distance between Sougui warehouse and your customers' },
    'distance.geoAnalysis': { fr: 'Analyse géographique', en: 'Geographic Analysis' },
    'distance.selectCompany': { fr: 'Sélectionnez une entreprise pour calculer la distance', en: 'Select a company to calculate distance' },
    'distance.chooseCompany': { fr: 'Choisissez une entreprise', en: 'Choose a company' },
    'distance.selectPlaceholder': { fr: '-- Sélectionnez une entreprise --', en: '-- Select a company --' },
    'distance.referencePoint': { fr: 'Point de référence (Entrepôt Sougui)', en: 'Reference Point (Sougui Warehouse)' },
    'distance.analyze': { fr: 'Analyser la distance', en: 'Analyze Distance' },
    'distance.analyzing': { fr: 'Calcul en cours...', en: 'Calculating...' },
    'distance.company': { fr: 'Entreprise', en: 'Company' },
    'distance.calculated': { fr: 'Distance calculée', en: 'Calculated Distance' },
    'distance.closeClient': { fr: 'Client proche', en: 'Close Customer' },
    'distance.farClient': { fr: 'Client éloigné', en: 'Far Customer' },
    'distance.proximityZone': { fr: 'Zone de proximité', en: 'Proximity Zone' },
    'distance.distantZone': { fr: 'Zone lointaine', en: 'Distant Zone' },
    'distance.fastDelivery': { fr: 'Ce client est situé dans la zone de livraison rapide', en: 'This customer is located in the fast delivery zone' },
    'distance.longDelivery': { fr: 'Ce client nécessite une livraison longue distance', en: 'This customer requires long-distance delivery' },
    'distance.proximityThreshold': { fr: 'Seuil de proximité', en: 'Proximity Threshold' },
    'distance.lessThan30km': { fr: 'Clients à moins de 30 km', en: 'Customers within 30 km' },
    'distance.fastDeliveryZone': { fr: 'Zone de livraison rapide', en: 'Fast Delivery Zone' },
    'distance.calculationMethod': { fr: 'Méthode de calcul', en: 'Calculation Method' },
    'distance.haversineFormula': { fr: 'Formule de Haversine', en: 'Haversine Formula' },
    'distance.preciseDistance': { fr: 'Distance orthodromique précise', en: 'Precise orthodromic distance' },
    
    // Predict Cost
    'predictCost.title': { fr: 'Prédiction du coût de transport', en: 'Transport Cost Prediction' },
    'predictCost.subtitle': { fr: 'Estimez instantanément le coût de livraison en fonction de la distance', en: 'Instantly estimate delivery cost based on distance' },
    'predictCost.costSimulation': { fr: 'Simulation de coût', en: 'Cost Simulation' },
    'predictCost.selectForEstimate': { fr: 'Sélectionnez une entreprise pour obtenir une estimation', en: 'Select a company to get an estimate' },
    'predictCost.chooseCompany': { fr: 'Choisissez une entreprise', en: 'Choose a company' },
    'predictCost.selectPlaceholder': { fr: '-- Sélectionnez une entreprise --', en: '-- Select a company --' },
    'predictCost.predict': { fr: 'Prédire le coût', en: 'Predict Cost' },
    'predictCost.predicting': { fr: 'Calcul en cours...', en: 'Calculating...' },
    'predictCost.company': { fr: 'Entreprise', en: 'Company' },
    'predictCost.distance': { fr: 'Distance', en: 'Distance' },
    'predictCost.estimatedCost': { fr: 'Coût estimé', en: 'Estimated Cost' },
    'predictCost.costEstimate': { fr: 'Estimation du coût', en: 'Cost Estimate' },
    'predictCost.baseRate': { fr: 'Tarif de base : 0.22 dt/km', en: 'Base rate: 0.22 dt/km' },
    'predictCost.pricing': { fr: 'Tarification', en: 'Pricing' },
    'predictCost.formula': { fr: 'Coût = 0,22 dt × Distance (km)', en: 'Cost = 0.22 dt × Distance (km)' },
    'predictCost.baseRateApplied': { fr: 'Tarif de base appliqué à toutes les livraisons', en: 'Base rate applied to all deliveries' },
    
    // Demand Prediction
    'demandPrediction.title': { fr: 'Prédiction de la Demande Produit B2B', en: 'Product Demand Prediction B2B' },
    'demandPrediction.subtitle': { fr: 'Anticipez les besoins futurs avec l\'intelligence artificielle', en: 'Anticipate future needs with artificial intelligence' },
    'demandPrediction.totalProducts': { fr: 'Produits', en: 'Products' },
    'demandPrediction.predictedUnits': { fr: 'Unités Prédites', en: 'Predicted Units' },
    'demandPrediction.months': { fr: 'Mois', en: 'Months' },
    'demandPrediction.selectProduct': { fr: 'Sélectionner un Produit', en: 'Select a Product' },
    'demandPrediction.searchPlaceholder': { fr: 'Rechercher un produit...', en: 'Search for a product...' },
    'demandPrediction.noResults': { fr: 'Aucun résultat pour', en: 'No results for' },
    'demandPrediction.noProducts': { fr: 'Aucun produit disponible', en: 'No products available' },
    'demandPrediction.selectProductTitle': { fr: 'Sélectionnez un Produit', en: 'Select a Product' },
    'demandPrediction.selectProductDesc': { fr: 'Choisissez un produit dans la liste pour prédire la demande des 3 prochains mois', en: 'Choose a product from the list to predict demand for the next 3 months' },
    'demandPrediction.predict': { fr: 'Prédire la Demande', en: 'Predict Demand' },
    'demandPrediction.predicting': { fr: 'Prédiction en cours...', en: 'Predicting...' },
    'demandPrediction.predictions': { fr: 'Prédictions', en: 'Predictions' },
    'demandPrediction.units': { fr: 'unités', en: 'units' },
    'demandPrediction.totalPredicted': { fr: 'Total Prédit (3 mois)', en: 'Total Predicted (3 months)' },
    
    // Best Seller B2C
    'bestSeller.title': { fr: 'Meilleur Vendeur B2C', en: 'Best Seller B2C' },
    'bestSeller.subtitle': { fr: 'Prédiction produit Best Seller en vente B2C', en: 'Best Seller product prediction in B2C sales' },
    'bestSeller.menuTitle': { fr: 'Meilleur Vendeur B2C', en: 'Best Seller B2C' },
    'bestSeller.menuDesc': { fr: 'Prédiction produit Best Seller en B2C', en: 'Best Seller product prediction in B2C' },
    'bestSeller.totalProducts': { fr: 'Produits', en: 'Products' },
    'bestSeller.probability': { fr: 'Probabilité', en: 'Probability' },
    'bestSeller.status': { fr: 'Statut', en: 'Status' },
    'bestSeller.selectProduct': { fr: 'Sélectionner un Produit', en: 'Select a Product' },
    'bestSeller.searchPlaceholder': { fr: 'Rechercher un produit...', en: 'Search for a product...' },
    'bestSeller.noResults': { fr: 'Aucun résultat pour', en: 'No results for' },
    'bestSeller.noProducts': { fr: 'Aucun produit disponible', en: 'No products available' },
    'bestSeller.predict': { fr: 'Prédire Best Seller', en: 'Predict Best Seller' },
    'bestSeller.predicting': { fr: 'Prédiction en cours...', en: 'Predicting...' },
    'bestSeller.result': { fr: 'Résultat', en: 'Result' },
    'bestSeller.high': { fr: 'Forte probabilité', en: 'High probability' },
    'bestSeller.medium': { fr: 'Probabilité moyenne', en: 'Medium probability' },
    'bestSeller.low': { fr: 'Faible probabilité', en: 'Low probability' },
    'bestSeller.totalQty': { fr: 'Qté Totale', en: 'Total Qty' },
    'bestSeller.nbOrders': { fr: 'Commandes', en: 'Orders' },
    'bestSeller.nbClients': { fr: 'Clients', en: 'Clients' },
    'bestSeller.caHT': { fr: 'CA HT', en: 'Revenue HT' },
    'bestSeller.rollingMean': { fr: 'Moy. Mobile', en: 'Rolling Avg' },
    'bestSeller.puHT': { fr: 'Prix Unitaire', en: 'Unit Price' },
    'bestSeller.selectProductTitle': { fr: 'Sélectionnez un Produit', en: 'Select a Product' },
    'bestSeller.selectProductDesc': { fr: 'Choisissez un produit pour prédire s\'il est un Best Seller en B2C', en: 'Choose a product to predict if it\'s a Best Seller in B2C' },
    
    // Price Simulator
    'PRICE_SIMULATOR_TITLE': { fr: 'Simulateur de Prix', en: 'Price Simulator' },
    'PRICE_SIMULATOR_SUBTITLE': { fr: 'Analysez l\'impact des changements de prix sur la compétitivité', en: 'Analyze the impact of price changes on competitiveness' },
    'priceSimulator.title': { fr: 'Simulateur de Prix', en: 'Price Simulator' },
    'priceSimulator.subtitle': { fr: 'Analysez l\'impact des changements de prix sur la compétitivité', en: 'Analyze the impact of price changes on competitiveness' },
    'priceSimulator.menuTitle': { fr: 'Simulateur de Prix', en: 'Price Simulator' },
    'priceSimulator.menuDesc': { fr: 'Analysez l\'impact des changements de prix sur la compétitivité', en: 'Analyze the impact of price changes on competitiveness' },
    'priceSimulator.selectProduct': { fr: 'Sélection du Produit', en: 'Product Selection' },
    'priceSimulator.currentSituation': { fr: 'Situation Actuelle', en: 'Current Situation' },
    'priceSimulator.priceSimulator': { fr: 'Simulateur de Prix', en: 'Price Simulator' },
    'priceSimulator.simulationResults': { fr: 'Résultats de la Simulation', en: 'Simulation Results' },
    'priceSimulator.aiRecommendation': { fr: 'Recommandation IA', en: 'AI Recommendation' },
    'priceSimulator.priceAnalysis': { fr: 'Analyse des Prix', en: 'Price Analysis' },
    'priceSimulator.competitivenessAnalysis': { fr: 'Analyse de Compétitivité', en: 'Competitiveness Analysis' },
    'priceSimulator.businessImpact': { fr: 'Impact Business', en: 'Business Impact' },
    'priceSimulator.mlPredictions': { fr: 'Prédictions ML', en: 'ML Predictions' },
    'priceSimulator.searchPlaceholder': { fr: 'Rechercher un produit...', en: 'Search for a product...' },
    'priceSimulator.noProducts': { fr: 'Aucun produit trouvé', en: 'No products found' },
    'priceSimulator.loading': { fr: 'Chargement des produits...', en: 'Loading products...' },
    'priceSimulator.simulate': { fr: 'Simuler le Prix', en: 'Simulate Price' },
    'priceSimulator.simulating': { fr: 'Simulation...', en: 'Simulating...' },
    'priceSimulator.reset': { fr: 'Réinitialiser', en: 'Reset' },
    'priceSimulator.selectProductToStart': { fr: 'Sélectionnez un produit pour commencer la simulation', en: 'Select a product to start the simulation' },
    'priceSimulator.selectProductDesc': { fr: 'Choisissez un produit dans la liste de gauche pour analyser l\'impact des changements de prix.', en: 'Choose a product from the left list to analyze the impact of price changes.' },
    
    // Client Segmentation
    'clientSegmentation.title': { fr: 'Segmentation des Clients', en: 'Client Segmentation' },
    'clientSegmentation.subtitle': { fr: 'Analyse comportementale des clients B2C avec Machine Learning', en: 'B2C client behavioral analysis with Machine Learning' },
    'clientSegmentation.menuTitle': { fr: 'Segmentation Clients', en: 'Client Segmentation' },
    'clientSegmentation.menuDesc': { fr: 'Classification des clients par comportement', en: 'Client classification by behavior' },
    'clientSegmentation.loading': { fr: 'Chargement de la segmentation...', en: 'Loading segmentation...' },
    'clientSegmentation.totalClients': { fr: 'Total Clients', en: 'Total Clients' },
    'clientSegmentation.vipClients': { fr: 'Clients VIP', en: 'VIP Clients' },
    'clientSegmentation.segments': { fr: 'Segments', en: 'Segments' },
    'clientSegmentation.segmentDistribution': { fr: 'Répartition des Segments', en: 'Segment Distribution' },
    'clientSegmentation.allSegments': { fr: 'Tous les segments', en: 'All segments' },
    'clientSegmentation.clients': { fr: 'clients', en: 'clients' },
    'clientSegmentation.clientsFound': { fr: 'clients trouvés', en: 'clients found' },
    'clientSegmentation.searchClient': { fr: 'Rechercher un client...', en: 'Search for a client...' },
    'clientSegmentation.noClientsFound': { fr: 'Aucun client trouvé', en: 'No clients found' },
    'clientSegmentation.noClientsInSegment': { fr: 'Aucun client dans ce segment', en: 'No clients in this segment' },
    'clientSegmentation.noClientsForSearch': { fr: 'Aucun client ne correspond à', en: 'No clients match' },
    'clientSegmentation.exportCSV': { fr: 'Exporter CSV', en: 'Export CSV' },
    'clientSegmentation.orders': { fr: 'commandes', en: 'orders' },
    'clientSegmentation.days': { fr: 'jours', en: 'days' },
    'clientSegmentation.recency': { fr: 'Récence', en: 'Recency' },
    'clientSegmentation.frequency': { fr: 'Fréquence', en: 'Frequency' },
    'clientSegmentation.monetary': { fr: 'Montant', en: 'Monetary' },
    'clientSegmentation.avgBasket': { fr: 'Panier Moyen', en: 'Avg Basket' },
    'clientSegmentation.totalRevenue': { fr: 'CA Total', en: 'Total Revenue' },
    'clientSegmentation.nbOrders': { fr: 'Nb Commandes', en: 'Nb Orders' },
    'clientSegmentation.daysSinceLastOrder': { fr: 'Jours depuis dernière commande', en: 'Days since last order' },
    
    // Supplier Classification
    'supplierClassification.title': { fr: 'Classification des Fournisseurs', en: 'Supplier Classification' },
    'supplierClassification.subtitle': { fr: 'Analyse et classification des fournisseurs avec Machine Learning', en: 'Supplier analysis and classification with Machine Learning' },
    'supplierClassification.menuTitle': { fr: 'Classification Fournisseurs', en: 'Supplier Classification' },
    'supplierClassification.menuDesc': { fr: 'Classifiez les fournisseurs recommandés', en: 'Classify recommended suppliers' },
    'supplierClassification.loading': { fr: 'Chargement des fournisseurs...', en: 'Loading suppliers...' },
    'supplierClassification.totalSuppliers': { fr: 'Total Fournisseurs', en: 'Total Suppliers' },
    'supplierClassification.recommended': { fr: 'Recommandés', en: 'Recommended' },
    'supplierClassification.notRecommended': { fr: 'Non Recommandés', en: 'Not Recommended' },
    'supplierClassification.selectSupplier': { fr: 'Sélection du Fournisseur', en: 'Supplier Selection' },
    'supplierClassification.searchSupplier': { fr: 'Rechercher un fournisseur...', en: 'Search for a supplier...' },
    'supplierClassification.noSuppliersFound': { fr: 'Aucun fournisseur trouvé', en: 'No suppliers found' },
    'supplierClassification.noSuppliersForSearch': { fr: 'Aucun fournisseur ne correspond à', en: 'No suppliers match' },
    'supplierClassification.classify': { fr: 'Classifier le Fournisseur', en: 'Classify Supplier' },
    'supplierClassification.classifying': { fr: 'Classification...', en: 'Classifying...' },
    'supplierClassification.classificationResult': { fr: 'Résultat de la Classification', en: 'Classification Result' },
    'supplierClassification.supplierInfo': { fr: 'Informations Fournisseur', en: 'Supplier Information' },
    'supplierClassification.name': { fr: 'Nom', en: 'Name' },
    'supplierClassification.matricule': { fr: 'Matricule Fiscal', en: 'Tax ID' },
    'supplierClassification.phone': { fr: 'Téléphone', en: 'Phone' },
    'supplierClassification.nbInvoices': { fr: 'Nb Factures', en: 'Nb Invoices' },
    'supplierClassification.nbProducts': { fr: 'Nb Produits', en: 'Nb Products' },
    'supplierClassification.totalAmount': { fr: 'Montant Total HT', en: 'Total Amount HT' },
    'supplierClassification.remainingDue': { fr: 'Reste Dû', en: 'Remaining Due' },
    'supplierClassification.paymentRate': { fr: 'Taux de Fiabilité', en: 'Reliability Rate' },
    'supplierClassification.recency': { fr: 'Récence', en: 'Recency' },
    'supplierClassification.daysAgo': { fr: 'jours', en: 'days ago' },
    'supplierClassification.confidence': { fr: 'Confiance', en: 'Confidence' },
    'supplierClassification.confidenceVeryHigh': { fr: 'Très Élevée', en: 'Very High' },
    'supplierClassification.confidenceHigh': { fr: 'Élevée', en: 'High' },
    'supplierClassification.confidenceMedium': { fr: 'Moyenne', en: 'Medium' },
    'supplierClassification.confidenceLow': { fr: 'Faible', en: 'Low' },
    'supplierClassification.status': { fr: 'Statut', en: 'Status' },
    'supplierClassification.statusRecommended': { fr: 'Fournisseur Recommandé', en: 'Recommended Supplier' },
    'supplierClassification.statusNotRecommended': { fr: 'Fournisseur Non Recommandé', en: 'Not Recommended Supplier' },
    'supplierClassification.analysis': { fr: 'Analyse Détaillée', en: 'Detailed Analysis' },
    'supplierClassification.strengths': { fr: 'Points Forts', en: 'Strengths' },
    'supplierClassification.weaknesses': { fr: 'Points Faibles', en: 'Weaknesses' },
    'supplierClassification.recommendation': { fr: 'Recommandation', en: 'Recommendation' },
    'supplierClassification.selectSupplierToStart': { fr: 'Sélectionnez un fournisseur pour commencer la classification', en: 'Select a supplier to start classification' },
    'supplierClassification.selectSupplierDesc': { fr: 'Choisissez un fournisseur dans la liste de gauche pour analyser sa performance.', en: 'Choose a supplier from the left list to analyze their performance.' },
    'supplierClassification.searchHint': { fr: 'Recherchez par nom ou matricule fiscal', en: 'Search by name or tax ID' },
    'supplierClassification.confidenceLevel': { fr: 'Niveau de Confiance', en: 'Confidence Level' },
    'supplierClassification.analyzedMetrics': { fr: 'Métriques Analysées', en: 'Analyzed Metrics' },
    'supplierClassification.activeMonths': { fr: 'Mois Actifs', en: 'Active Months' },
    'supplierClassification.lastPurchase': { fr: 'Dernier Achat', en: 'Last Purchase' },
    'supplierClassification.days': { fr: 'jours', en: 'days' },
    'supplierClassification.trainModel': { fr: 'Entraîner le Modèle', en: 'Train Model' },
    'supplierClassification.training': { fr: 'Entraînement...', en: 'Training...' },
    'supplierClassification.trainSuccess': { fr: 'Modèle entraîné avec succès', en: 'Model trained successfully' },
    'supplierClassification.trainError': { fr: 'Erreur lors de l\'entraînement du modèle', en: 'Error training the model' },
    'supplierClassification.segment': { fr: 'Segment', en: 'Segment' },
    'supplierClassification.segmentBtn': { fr: 'Segmenter le Fournisseur', en: 'Segment Supplier' },
    'supplierClassification.segmentationResult': { fr: 'Résultat de la Segmentation', en: 'Segmentation Result' },
    'supplierClassification.segmentCle': { fr: 'Fournisseur Clé', en: 'Key Supplier' },
    'supplierClassification.segmentStandard': { fr: 'Fournisseur Standard', en: 'Standard Supplier' },
    // Common errors
    ...
    'common.tryAgain': { fr: 'Réessayer', en: 'Try Again' },
    
    // Distance Analysis Additional Keys
    'distance.selectForAnalysis': { fr: 'Sélectionnez une entreprise pour calculer la distance', en: 'Select a company to calculate distance' },
    'distance.referencePointDesc': { fr: 'Point de référence (Entrepôt Sougui)', en: 'Reference Point (Sougui Warehouse)' },
    'distance.proximityZoneAbbr': { fr: 'Proximité', en: 'Proximity' },
    'distance.distantZoneAbbr': { fr: 'Éloigné', en: 'Distant' },
    
    // Predict Cost Additional Keys
    'predictCost.formulaDesc': { fr: 'Formule : 0.22 dt × Distance (km)', en: 'Formula: 0.22 dt × Distance (km)' },
    'predictCost.baseRateDesc': { fr: 'Tarif appliqué à toutes les livraisons', en: 'Rate applied to all deliveries' },
    ...
    'mlSecurity.accessDenied': { fr: 'Accès Demandé', en: 'Access Requested' },
    'mlSecurity.mlModels': { fr: 'Modèles ML', en: 'ML Models' },
    'mlSecurity.passwordRequired': { fr: 'Pour accéder aux modèles de Machine Learning, confirmez votre mot de passe.', en: 'To access Machine Learning models, confirm your password.' },
    'mlSecurity.expiresInfo': { fr: 'La vérification expire après 30 minutes d\'inactivité.', en: 'Verification expires after 30 minutes of inactivity.' },
    'mlSecurity.adminPassword': { fr: 'MOT DE PASSE ADMINISTRATEUR', en: 'ADMINISTRATOR PASSWORD' },
    'mlSecurity.passwordPlaceholder': { fr: 'Entrez votre mot de passe', en: 'Enter your password' },
    'mlSecurity.incorrectPassword': { fr: 'Mot de passe incorrect', en: 'Incorrect password' },
    'mlSecurity.confirmAccess': { fr: 'Confirmer l\'accès', en: 'Confirm Access' },
    'mlSecurity.verifying': { fr: 'Vérification...', en: 'Verifying...' },
    'mlSecurity.backHome': { fr: 'Retour à l\'accueil', en: 'Back to Home' },
  };
